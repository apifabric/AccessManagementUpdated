...
resourcename="accessmanagementiter1"  # lower case, only
resourcegroup="accessmanagementiter1_rg"
...
# git clone https://github.com/apilogicserver/accessmanagementiter1.git
# cd accessmanagementiter1
...
az group create --name accessmanagementiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group accessmanagementiter1_rg --sku S1 --is-linux
az container create --resource-group accessmanagementiter1_rg --name accessmanagementiter1 --image apilogicserver/accessmanagementiter1:latest --dns-name-label accessmanagementiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//accessmanagementiter1.westus.azurecontainer.io:5656'
